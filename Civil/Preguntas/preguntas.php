...
mysqli_select_db($con,$db_database)or die("problemas al conectar con la base de datos");
	        ...
	        if (isset($_REQUEST['Enviar'])){
                        ...
                        if($elementosEA=='si'){
                        $tamanoArchivo1 = $_FILES['fotoasentamiento']['size'];
						$imagenSubida1 = fopen($_FILES['fotoasentamiento']['tmp_name'], 'r');
                        $binariosImagen1 = fread($imagenSubida1, $tamanoArchivo1);

                        $binariosImagen1 = mysqli_escape_string($con, $binariosImagen1);

                        $tamanoArchivo2 = $_FILES['fotoasentamiento2']['size'];
						$imagenSubida2 = fopen($_FILES['fotoasentamiento2']['tmp_name'], 'r');
                        $binariosImagen2 = fread($imagenSubida2, $tamanoArchivo2);

                        $binariosImagen2 = mysqli_escape_string($con, $binariosImagen2);
                        }else{
                                $binariosImagen1=NULL;
                                $binariosImagen2=NULL;
                        }
                        ...
                        if($elementosGC=='si'){
                        $tamanoArchivo3 = $_FILES['fotogrieta']['size'];
						$imagenSubida3 = fopen($_FILES['fotogrieta']['tmp_name'], 'r');
                        $binariosImagen3 = fread($imagenSubida3, $tamanoArchivo3);

                        $binariosImagen3 = mysqli_escape_string($con, $binariosImagen3);

                        $tamanoArchivo4 = $_FILES['fotogrieta2']['size'];
						$imagenSubida4 = fopen($_FILES['fotogrieta2']['tmp_name'], 'r');
                        $binariosImagen4 = fread($imagenSubida4, $tamanoArchivo4);

                        $binariosImagen4 = mysqli_escape_string($con, $binariosImagen4);
                        }else{
                                $binariosImagen3=NULL;
                                $binariosImagen4=NULL;
                        }
                        ...
                        nro_sotanos, muro_vecinos, elementos, altura_pisos, material, tipo, piso, techo, asentamiento,foto_asentamiento1,foto_asentamiento2, grietas, foto_grieta1,foto_grieta2,vulnerabilidad) values 
                                ...
                                '$elementosSP','$elementosMU','$elementosEQ','$elementosAP','$elementosMCV','$elementostipo','$elementosCPV','$elementosMCTV','$elementosEA','" . $binariosImagen1 . "','" . $binariosImagen2 . "',
                                '$elementosGC','" . $binariosImagen3 . "','" . $binariosImagen4 . "','$color'); ";
